...
const METHOD_OPERATIONS_DELETE_OPERATION: ::grpcio::Method<super::operations::DeleteOperationRequest, super::super::protobuf::empty::Empty> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_OPERATIONS_CANCEL_OPERATION: ::grpcio::Method<super::operations::CancelOperationRequest, super::super::protobuf::empty::Empty> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl OperationsClient {
    ...
    pub fn delete_operation_opt(&self, req: &super::operations::DeleteOperationRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::protobuf::empty::Empty> {
        self.client.unary_call(&METHOD_OPERATIONS_DELETE_OPERATION, req, opt)
    }

    pub fn delete_operation(&self, req: &super::operations::DeleteOperationRequest) -> ::grpcio::Result<super::super::protobuf::empty::Empty> {
        self.delete_operation_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delete_operation_async_opt(&self, req: &super::operations::DeleteOperationRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::protobuf::empty::Empty>> {
        self.client.unary_call_async(&METHOD_OPERATIONS_DELETE_OPERATION, req, opt)
    }

    pub fn delete_operation_async(&self, req: &super::operations::DeleteOperationRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::protobuf::empty::Empty>> {
        self.delete_operation_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn cancel_operation_opt(&self, req: &super::operations::CancelOperationRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::protobuf::empty::Empty> {
        self.client.unary_call(&METHOD_OPERATIONS_CANCEL_OPERATION, req, opt)
    }

    pub fn cancel_operation(&self, req: &super::operations::CancelOperationRequest) -> ::grpcio::Result<super::super::protobuf::empty::Empty> {
        self.cancel_operation_opt(req, ::grpcio::CallOption::default())
    }

    pub fn cancel_operation_async_opt(&self, req: &super::operations::CancelOperationRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::protobuf::empty::Empty>> {
        self.client.unary_call_async(&METHOD_OPERATIONS_CANCEL_OPERATION, req, opt)
    }

    pub fn cancel_operation_async(&self, req: &super::operations::CancelOperationRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::protobuf::empty::Empty>> {
        self.cancel_operation_async_opt(req, ::grpcio::CallOption::default())
    }
    pub fn spawn<F>(&self, f: F) where F: futures::future::Future<Item = (), Error = ()> + Send + 'static {
        self.client.spawn(f)
    }
}

pub trait Operations {
    fn list_operations(&self, ctx: ::grpcio::RpcContext, req: super::operations::ListOperationsRequest, sink: ::grpcio::UnarySink<super::operations::ListOperationsResponse>);
    fn get_operation(&self, ctx: ::grpcio::RpcContext, req: super::operations::GetOperationRequest, sink: ::grpcio::UnarySink<super::operations::Operation>);
    fn delete_operation(&self, ctx: ::grpcio::RpcContext, req: super::operations::DeleteOperationRequest, sink: ::grpcio::UnarySink<super::super::protobuf::empty::Empty>);
    fn cancel_operation(&self, ctx: ::grpcio::RpcContext, req: super::operations::CancelOperationRequest, sink: ::grpcio::UnarySink<super::super::protobuf::empty::Empty>);
}
