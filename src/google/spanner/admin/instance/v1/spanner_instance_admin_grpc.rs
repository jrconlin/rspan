...
const METHOD_INSTANCE_ADMIN_CREATE_INSTANCE: ::grpcio::Method<super::spanner_instance_admin::CreateInstanceRequest, super::super::super::super::super::longrunning::operations::Operation> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSTANCE_ADMIN_UPDATE_INSTANCE: ::grpcio::Method<super::spanner_instance_admin::UpdateInstanceRequest, super::super::super::super::super::longrunning::operations::Operation> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSTANCE_ADMIN_DELETE_INSTANCE: ::grpcio::Method<super::spanner_instance_admin::DeleteInstanceRequest, super::super::super::super::super::protobuf::empty::Empty> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSTANCE_ADMIN_SET_IAM_POLICY: ::grpcio::Method<super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest, super::super::super::super::super::iam::policy::Policy> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSTANCE_ADMIN_GET_IAM_POLICY: ::grpcio::Method<super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest, super::super::super::super::super::iam::policy::Policy> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_INSTANCE_ADMIN_TEST_IAM_PERMISSIONS: ::grpcio::Method<super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest, super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl InstanceAdminClient {
    ...
    pub fn create_instance_opt(&self, req: &super::spanner_instance_admin::CreateInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::longrunning::operations::Operation> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_CREATE_INSTANCE, req, opt)
    }

    pub fn create_instance(&self, req: &super::spanner_instance_admin::CreateInstanceRequest) -> ::grpcio::Result<super::super::super::super::super::longrunning::operations::Operation> {
        self.create_instance_opt(req, ::grpcio::CallOption::default())
    }

    pub fn create_instance_async_opt(&self, req: &super::spanner_instance_admin::CreateInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::longrunning::operations::Operation>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_CREATE_INSTANCE, req, opt)
    }

    pub fn create_instance_async(&self, req: &super::spanner_instance_admin::CreateInstanceRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::longrunning::operations::Operation>> {
        self.create_instance_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn update_instance_opt(&self, req: &super::spanner_instance_admin::UpdateInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::longrunning::operations::Operation> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_UPDATE_INSTANCE, req, opt)
    }

    pub fn update_instance(&self, req: &super::spanner_instance_admin::UpdateInstanceRequest) -> ::grpcio::Result<super::super::super::super::super::longrunning::operations::Operation> {
        self.update_instance_opt(req, ::grpcio::CallOption::default())
    }

    pub fn update_instance_async_opt(&self, req: &super::spanner_instance_admin::UpdateInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::longrunning::operations::Operation>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_UPDATE_INSTANCE, req, opt)
    }

    pub fn update_instance_async(&self, req: &super::spanner_instance_admin::UpdateInstanceRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::longrunning::operations::Operation>> {
        self.update_instance_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delete_instance_opt(&self, req: &super::spanner_instance_admin::DeleteInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::protobuf::empty::Empty> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_DELETE_INSTANCE, req, opt)
    }

    pub fn delete_instance(&self, req: &super::spanner_instance_admin::DeleteInstanceRequest) -> ::grpcio::Result<super::super::super::super::super::protobuf::empty::Empty> {
        self.delete_instance_opt(req, ::grpcio::CallOption::default())
    }

    pub fn delete_instance_async_opt(&self, req: &super::spanner_instance_admin::DeleteInstanceRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::protobuf::empty::Empty>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_DELETE_INSTANCE, req, opt)
    }

    pub fn delete_instance_async(&self, req: &super::spanner_instance_admin::DeleteInstanceRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::protobuf::empty::Empty>> {
        self.delete_instance_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn set_iam_policy_opt(&self, req: &super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::iam::policy::Policy> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_SET_IAM_POLICY, req, opt)
    }

    pub fn set_iam_policy(&self, req: &super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest) -> ::grpcio::Result<super::super::super::super::super::iam::policy::Policy> {
        self.set_iam_policy_opt(req, ::grpcio::CallOption::default())
    }

    pub fn set_iam_policy_async_opt(&self, req: &super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::policy::Policy>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_SET_IAM_POLICY, req, opt)
    }

    pub fn set_iam_policy_async(&self, req: &super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::policy::Policy>> {
        self.set_iam_policy_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn get_iam_policy_opt(&self, req: &super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::iam::policy::Policy> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_GET_IAM_POLICY, req, opt)
    }

    pub fn get_iam_policy(&self, req: &super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest) -> ::grpcio::Result<super::super::super::super::super::iam::policy::Policy> {
        self.get_iam_policy_opt(req, ::grpcio::CallOption::default())
    }

    pub fn get_iam_policy_async_opt(&self, req: &super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::policy::Policy>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_GET_IAM_POLICY, req, opt)
    }

    pub fn get_iam_policy_async(&self, req: &super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::policy::Policy>> {
        self.get_iam_policy_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn test_iam_permissions_opt(&self, req: &super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse> {
        self.client.unary_call(&METHOD_INSTANCE_ADMIN_TEST_IAM_PERMISSIONS, req, opt)
    }

    pub fn test_iam_permissions(&self, req: &super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest) -> ::grpcio::Result<super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse> {
        self.test_iam_permissions_opt(req, ::grpcio::CallOption::default())
    }

    pub fn test_iam_permissions_async_opt(&self, req: &super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse>> {
        self.client.unary_call_async(&METHOD_INSTANCE_ADMIN_TEST_IAM_PERMISSIONS, req, opt)
    }

    pub fn test_iam_permissions_async(&self, req: &super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse>> {
...
pub trait InstanceAdmin {
    fn list_instance_configs(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::ListInstanceConfigsRequest, sink: ::grpcio::UnarySink<super::spanner_instance_admin::ListInstanceConfigsResponse>);
    fn get_instance_config(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::GetInstanceConfigRequest, sink: ::grpcio::UnarySink<super::spanner_instance_admin::InstanceConfig>);
    fn list_instances(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::ListInstancesRequest, sink: ::grpcio::UnarySink<super::spanner_instance_admin::ListInstancesResponse>);
    fn get_instance(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::GetInstanceRequest, sink: ::grpcio::UnarySink<super::spanner_instance_admin::Instance>);
    fn create_instance(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::CreateInstanceRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::longrunning::operations::Operation>);
    fn update_instance(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::UpdateInstanceRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::longrunning::operations::Operation>);
    fn delete_instance(&self, ctx: ::grpcio::RpcContext, req: super::spanner_instance_admin::DeleteInstanceRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::protobuf::empty::Empty>);
    fn set_iam_policy(&self, ctx: ::grpcio::RpcContext, req: super::super::super::super::super::iam::iam_policy::SetIamPolicyRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::iam::policy::Policy>);
    fn get_iam_policy(&self, ctx: ::grpcio::RpcContext, req: super::super::super::super::super::iam::iam_policy::GetIamPolicyRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::iam::policy::Policy>);
    fn test_iam_permissions(&self, ctx: ::grpcio::RpcContext, req: super::super::super::super::super::iam::iam_policy::TestIamPermissionsRequest, sink: ::grpcio::UnarySink<super::super::super::super::super::iam::iam_policy::TestIamPermissionsResponse>);
}
