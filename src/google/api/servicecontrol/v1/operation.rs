...
impl ::protobuf::Message for Operation {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.importance != Operation_Importance::LOW {
            os.write_enum(11, self.importance.value())?;
        }
...
impl ::protobuf::Clear for Operation {
    fn clear(&mut self) {
        ...
        self.clear_operation_name();
        self.clear_consumer_id();
        self.clear_start_time();
        self.clear_end_time();
        self.clear_labels();
        self.clear_metric_value_sets();
...
impl ::protobuf::ProtobufEnum for Operation_Importance {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("Operation_Importance", file_descriptor_proto())
            })
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    cecontrol/v1;servicecontrol\xf8\x01\x01J\xf8%\n\x06\x12\x04\x0e\0o\x01\n\
    ...
    \x03\x18\0a\n\x0b\n\x04\x08\xe7\x07\x01\x12\x03\x18\0a\n\x0c\n\x05\x08\
    \xe7\x07\x01\x02\x12\x03\x18\x07\x11\n\r\n\x06\x08\xe7\x07\x01\x02\0\x12\
    \x03\x18\x07\x11\n\x0e\n\x07\x08\xe7\x07\x01\x02\0\x01\x12\x03\x18\x07\
    \x11\n\x0c\n\x05\x08\xe7\x07\x01\x07\x12\x03\x18\x14`\n\x08\n\x01\x08\
    \x12\x03\x19\0\"\n\x0b\n\x04\x08\xe7\x07\x02\x12\x03\x19\0\"\n\x0c\n\x05\
    \x08\xe7\x07\x02\x02\x12\x03\x19\x07\x1a\n\r\n\x06\x08\xe7\x07\x02\x02\0\
    ...
    \x02\0\x12\x03\x1a\x07\x1b\n\x0e\n\x07\x08\xe7\x07\x03\x02\0\x01\x12\x03\
    \x1a\x07\x1b\n\x0c\n\x05\x08\xe7\x07\x03\x07\x12\x03\x1a\x1e.\n\x08\n\
    \x01\x08\x12\x03\x1b\09\n\x0b\n\x04\x08\xe7\x07\x04\x12\x03\x1b\09\n\x0c\
    \n\x05\x08\xe7\x07\x04\x02\x12\x03\x1b\x07\x13\n\r\n\x06\x08\xe7\x07\x04\
    \x02\0\x12\x03\x1b\x07\x13\n\x0e\n\x07\x08\xe7\x07\x04\x02\0\x01\x12\x03\
    \x1b\x07\x13\n\x0c\n\x05\x08\xe7\x07\x04\x07\x12\x03\x1b\x168\n<\n\x02\
    \x04\0\x12\x04\x1f\0o\x01\x1a0\x20Represents\x20information\x20regarding\
    \x20an\x20operation.\n\n\n\n\x03\x04\0\x01\x12\x03\x1f\x08\x11\nN\n\x04\
    \x04\0\x04\0\x12\x04!\x02*\x03\x1a@\x20Defines\x20the\x20importance\x20o\
    f\x20the\x20data\x20contained\x20in\x20the\x20operation.\n\n\x0c\n\x05\
    \x04\0\x04\0\x01\x12\x03!\x07\x11\n\x90\x01\n\x06\x04\0\x04\0\x02\0\x12\
    \x03$\x04\x0c\x1a\x80\x01\x20The\x20API\x20implementation\x20may\x20cach\
    e\x20and\x20aggregate\x20the\x20data.\n\x20The\x20data\x20may\x20be\x20l\
    ost\x20when\x20rare\x20and\x20unexpected\x20system\x20failures\x20occur.\
    \n\n\x0e\n\x07\x04\0\x04\0\x02\0\x01\x12\x03$\x04\x07\n\x0e\n\x07\x04\0\
    \x04\0\x02\0\x02\x12\x03$\n\x0b\n\xb9\x01\n\x06\x04\0\x04\0\x02\x01\x12\
    \x03)\x04\r\x1a\xa9\x01\x20The\x20API\x20implementation\x20doesn't\x20ca\
    che\x20and\x20aggregate\x20the\x20data.\n\x20If\x20the\x20method\x20retu\
    rns\x20successfully,\x20it's\x20guaranteed\x20that\x20the\x20data\x20has\
    \n\x20been\x20persisted\x20in\x20durable\x20storage.\n\n\x0e\n\x07\x04\0\
    \x04\0\x02\x01\x01\x12\x03)\x04\x08\n\x0e\n\x07\x04\0\x04\0\x02\x01\x02\
    \x12\x03)\x0b\x0c\n\xdd\x03\n\x04\x04\0\x02\0\x12\x035\x02\x1a\x1a\xcf\
    \x03\x20Identity\x20of\x20the\x20operation.\x20This\x20must\x20be\x20uni\
    que\x20within\x20the\x20scope\x20of\x20the\n\x20service\x20that\x20gener\
    ated\x20the\x20operation.\x20If\x20the\x20service\x20calls\n\x20Check()\
    \x20and\x20Report()\x20on\x20the\x20same\x20operation,\x20the\x20two\x20\
    calls\x20should\x20carry\n\x20the\x20same\x20id.\n\n\x20UUID\x20version\
    \x204\x20is\x20recommended,\x20though\x20not\x20required.\n\x20In\x20sce\
    narios\x20where\x20an\x20operation\x20is\x20computed\x20from\x20existing\
    \x20information\n\x20and\x20an\x20idempotent\x20id\x20is\x20desirable\
    \x20for\x20deduplication\x20purpose,\x20UUID\x20version\x205\n\x20is\x20\
    recommended.\x20See\x20RFC\x204122\x20for\x20details.\n\n\r\n\x05\x04\0\
    \x02\0\x04\x12\x045\x02*\x03\n\x0c\n\x05\x04\0\x02\0\x05\x12\x035\x02\
    \x08\n\x0c\n\x05\x04\0\x02\0\x01\x12\x035\t\x15\n\x0c\n\x05\x04\0\x02\0\
    \x03\x12\x035\x18\x19\nN\n\x04\x04\0\x02\x01\x12\x038\x02\x1c\x1aA\x20Fu\
    lly\x20qualified\x20name\x20of\x20the\x20operation.\x20Reserved\x20for\
    \x20future\x20use.\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x048\x025\x1a\n\x0c\
    \n\x05\x04\0\x02\x01\x05\x12\x038\x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\
    \x12\x038\t\x17\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x038\x1a\x1b\n\xe8\x02\
    \n\x04\x04\0\x02\x02\x12\x03C\x02\x19\x1a\xda\x02\x20Identity\x20of\x20t\
    he\x20consumer\x20who\x20is\x20using\x20the\x20service.\n\x20This\x20fie\
    ld\x20should\x20be\x20filled\x20in\x20for\x20the\x20operations\x20initia\
    ted\x20by\x20a\n\x20consumer,\x20but\x20not\x20for\x20service-initiated\
    \x20operations\x20that\x20are\n\x20not\x20related\x20to\x20a\x20specific\
    \x20consumer.\n\n\x20This\x20can\x20be\x20in\x20one\x20of\x20the\x20foll\
    owing\x20formats:\n\x20\x20\x20project:<project_id>,\n\x20\x20\x20projec\
    t_number:<project_number>,\n\x20\x20\x20api_key:<api_key>.\n\n\r\n\x05\
    \x04\0\x02\x02\x04\x12\x04C\x028\x1c\n\x0c\n\x05\x04\0\x02\x02\x05\x12\
    \x03C\x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03C\t\x14\n\x0c\n\x05\
    \x04\0\x02\x02\x03\x12\x03C\x17\x18\n5\n\x04\x04\0\x02\x03\x12\x03F\x02+\
    \x1a(\x20Required.\x20Start\x20time\x20of\x20the\x20operation.\n\n\r\n\
    \x05\x04\0\x02\x03\x04\x12\x04F\x02C\x19\n\x0c\n\x05\x04\0\x02\x03\x06\
    \x12\x03F\x02\x1b\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03F\x1c&\n\x0c\n\
    \x05\x04\0\x02\x03\x03\x12\x03F)*\n\xa2\x02\n\x04\x04\0\x02\x04\x12\x03K\
    \x02)\x1a\x94\x02\x20End\x20time\x20of\x20the\x20operation.\n\x20Require\
    d\x20when\x20the\x20operation\x20is\x20used\x20in\x20[ServiceController.\
    ...
    \x03\\\x02!\x1a\x95\x06\x20Labels\x20describing\x20the\x20operation.\x20\
    Only\x20the\x20following\x20labels\x20are\x20allowed:\n\n\x20-\x20Labels\
    ...
    ed\x20(e.g.\x20GAE,\x20GCE,\x20GKE).\n\n\r\n\x05\x04\0\x02\x05\x04\x12\
    \x04\\\x02K)\n\x0c\n\x05\x04\0\x02\x05\x06\x12\x03\\\x02\x15\n\x0c\n\x05\
    \x04\0\x02\x05\x01\x12\x03\\\x16\x1c\n\x0c\n\x05\x04\0\x02\x05\x03\x12\
    \x03\\\x1f\x20\n\x9a\x04\n\x04\x04\0\x02\x06\x12\x03h\x020\x1a\x8c\x04\
    \x20Represents\x20information\x20about\x20this\x20operation.\x20Each\x20\
    MetricValueSet\n\x20corresponds\x20to\x20a\x20metric\x20defined\x20in\
    \x20the\x20service\x20configuration.\n\x20The\x20data\x20type\x20used\
    \x20in\x20the\x20MetricValueSet\x20must\x20agree\x20with\n\x20the\x20dat\
    a\x20type\x20specified\x20in\x20the\x20metric\x20definition.\n\n\x20With\
    in\x20a\x20single\x20operation,\x20it\x20is\x20not\x20allowed\x20to\x20h\
    ave\x20more\x20than\x20one\n\x20MetricValue\x20instances\x20that\x20have\
    \x20the\x20same\x20metric\x20names\x20and\x20identical\n\x20label\x20val\
    ue\x20combinations.\x20If\x20a\x20request\x20has\x20such\x20duplicated\
    \x20MetricValue\n\x20instances,\x20the\x20entire\x20request\x20is\x20rej\
    ected\x20with\n\x20an\x20invalid\x20argument\x20error.\n\n\x0c\n\x05\x04\
    \0\x02\x06\x04\x12\x03h\x02\n\n\x0c\n\x05\x04\0\x02\x06\x06\x12\x03h\x0b\
    \x19\n\x0c\n\x05\x04\0\x02\x06\x01\x12\x03h\x1a+\n\x0c\n\x05\x04\0\x02\
    \x06\x03\x12\x03h./\n3\n\x04\x04\0\x02\x07\x12\x03k\x02$\x1a&\x20Represe\
    nts\x20information\x20to\x20be\x20logged.\n\n\x0c\n\x05\x04\0\x02\x07\
    \x04\x12\x03k\x02\n\n\x0c\n\x05\x04\0\x02\x07\x06\x12\x03k\x0b\x13\n\x0c\
    \n\x05\x04\0\x02\x07\x01\x12\x03k\x14\x1f\n\x0c\n\x05\x04\0\x02\x07\x03\
    \x12\x03k\"#\n9\n\x04\x04\0\x02\x08\x12\x03n\x02\x1d\x1a,\x20DO\x20NOT\
    \x20USE.\x20This\x20is\x20an\x20experimental\x20field.\n\n\r\n\x05\x04\0\
    \x02\x08\x04\x12\x04n\x02k$\n\x0c\n\x05\x04\0\x02\x08\x06\x12\x03n\x02\
    \x0c\n\x0c\n\x05\x04\0\x02\x08\x01\x12\x03n\r\x17\n\x0c\n\x05\x04\0\x02\
    \x08\x03\x12\x03n\x1a\x1cb\x06proto3\
";
