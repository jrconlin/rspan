...
pub trait ServiceController {
    fn check(&self, ctx: ::grpcio::RpcContext, req: super::service_controller::CheckRequest, sink: ::grpcio::UnarySink<super::service_controller::CheckResponse>);
    fn report(&self, ctx: ::grpcio::RpcContext, req: super::service_controller::ReportRequest, sink: ::grpcio::UnarySink<super::service_controller::ReportResponse>);
}
