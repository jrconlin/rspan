...
pub trait QuotaController {
    fn allocate_quota(&self, ctx: ::grpcio::RpcContext, req: super::quota_controller::AllocateQuotaRequest, sink: ::grpcio::UnarySink<super::quota_controller::AllocateQuotaResponse>);
}
