...
impl ::protobuf::Message for ConfigChange {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.change_type != ChangeType::CHANGE_TYPE_UNSPECIFIED {
            os.write_enum(4, self.change_type.value())?;
        }
        for v in &self.advices {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<ConfigChange>(
                    "ConfigChange",
                    fields,
    ...
    fn default_instance() -> &'static ConfigChange {
        static mut instance: ::protobuf::lazy::Lazy<ConfigChange> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ConfigChange,
        };
        unsafe {
...
impl ::protobuf::Message for Advice {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<Advice>(
                    "Advice",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Advice {
        static mut instance: ::protobuf::lazy::Lazy<Advice> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Advice,
        };
        unsafe {
...
impl ::protobuf::ProtobufEnum for ChangeType {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("ChangeType", file_descriptor_proto())
            })
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ge;configchange\xa2\x02\x04GAPIJ\xe3\x1b\n\x06\x12\x04\x0e\0T\x01\n\xbd\
    ...
    \x08\x12\x03\x12\0Z\n\x0b\n\x04\x08\xe7\x07\0\x12\x03\x12\0Z\n\x0c\n\x05\
    \x08\xe7\x07\0\x02\x12\x03\x12\x07\x11\n\r\n\x06\x08\xe7\x07\0\x02\0\x12\
    \x03\x12\x07\x11\n\x0e\n\x07\x08\xe7\x07\0\x02\0\x01\x12\x03\x12\x07\x11\
    \n\x0c\n\x05\x08\xe7\x07\0\x07\x12\x03\x12\x14Y\n\x08\n\x01\x08\x12\x03\
    ...
    \x12\x04\x1f\09\x01\x1a\x81\x02\x20Output\x20generated\x20from\x20semant\
    ically\x20comparing\x20two\x20versions\x20of\x20a\x20service\n\x20config\
    uration.\n\n\x20Includes\x20detailed\x20information\x20about\x20a\x20fie\
    ld\x20that\x20have\x20changed\x20with\n\x20applicable\x20advice\x20about\
    \x20potential\x20consequences\x20for\x20the\x20change,\x20such\x20as\n\
    \x20backwards-incompatibility.\n\n\n\n\x03\x04\0\x01\x12\x03\x1f\x08\x14\
    \n\x80\x04\n\x04\x04\0\x02\0\x12\x03)\x02\x15\x1a\xf2\x03\x20Object\x20h\
    ierarchy\x20path\x20to\x20the\x20change,\x20with\x20levels\x20separated\
    \x20by\x20a\x20'.'\n\x20character.\x20For\x20repeated\x20fields,\x20an\
    \x20applicable\x20unique\x20identifier\x20field\x20is\n\x20used\x20for\
    \x20the\x20index\x20(usually\x20selector,\x20name,\x20or\x20id).\x20For\
    \x20maps,\x20the\x20term\n\x20'key'\x20is\x20used.\x20If\x20the\x20field\
    \x20has\x20no\x20unique\x20identifier,\x20the\x20numeric\x20index\n\x20i\
    s\x20used.\n\x20Examples:\n\x20-\x20visibility.rules[selector==\"google.\
    LibraryService.CreateBook\"].restriction\n\x20-\x20quota.metric_rules[se\
    lector==\"google\"].metric_costs[key==\"reads\"].value\n\x20-\x20logging\
    .producer_destinations[0]\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04)\x02\x1f\
    ...
    \x03\x12\x03-\x15\x16\n\x99\x01\n\x04\x04\0\x02\x02\x12\x031\x02\x17\x1a\
    \x8b\x01\x20Value\x20of\x20the\x20changed\x20object\x20in\x20the\x20new\
    \x20Service\x20configuration,\n\x20in\x20JSON\x20format.\x20This\x20fiel\
    d\x20will\x20not\x20be\x20populated\x20if\x20ChangeType\x20==\x20REMOVED\
    .\n\n\r\n\x05\x04\0\x02\x02\x04\x12\x041\x02-\x17\n\x0c\n\x05\x04\0\x02\
    \x02\x05\x12\x031\x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x031\t\x12\n\
    \x0c\n\x05\x04\0\x02\x02\x03\x12\x031\x15\x16\nL\n\x04\x04\0\x02\x03\x12\
    \x034\x02\x1d\x1a?\x20The\x20type\x20for\x20this\x20change,\x20either\
    \x20ADDED,\x20REMOVED,\x20or\x20MODIFIED.\n\n\r\n\x05\x04\0\x02\x03\x04\
    \x12\x044\x021\x17\n\x0c\n\x05\x04\0\x02\x03\x06\x12\x034\x02\x0c\n\x0c\
    \n\x05\x04\0\x02\x03\x01\x12\x034\r\x18\n\x0c\n\x05\x04\0\x02\x03\x03\
    \x12\x034\x1b\x1c\ny\n\x04\x04\0\x02\x04\x12\x038\x02\x1e\x1al\x20Collec\
    tion\x20of\x20advice\x20provided\x20for\x20this\x20change,\x20useful\x20\
    for\x20determining\x20the\n\x20possible\x20impact\x20of\x20this\x20chang\
    ...
    \x03\x12\x03@\x17\x18\nb\n\x02\x05\0\x12\x04E\0T\x01\x1aV\x20Classifies\
    \x20set\x20of\x20possible\x20modifications\x20to\x20an\x20object\x20in\
    \x20the\x20service\n\x20configuration.\n\n\n\n\x03\x05\0\x01\x12\x03E\
    \x05\x0f\n%\n\x04\x05\0\x02\0\x12\x03G\x02\x1e\x1a\x18\x20No\x20value\
    \x20was\x20provided.\n\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03G\x02\x19\n\
    \x0c\n\x05\x05\0\x02\0\x02\x12\x03G\x1c\x1d\ny\n\x04\x05\0\x02\x01\x12\
    \x03K\x02\x0c\x1al\x20The\x20changed\x20object\x20exists\x20in\x20the\
    \x20'new'\x20service\x20configuration,\x20but\x20not\n\x20in\x20the\x20'\
    old'\x20service\x20configuration.\n\n\x0c\n\x05\x05\0\x02\x01\x01\x12\
    \x03K\x02\x07\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03K\n\x0b\ny\n\x04\x05\
    \0\x02\x02\x12\x03O\x02\x0e\x1al\x20The\x20changed\x20object\x20exists\
    \x20in\x20the\x20'old'\x20service\x20configuration,\x20but\x20not\n\x20i\
    n\x20the\x20'new'\x20service\x20configuration.\n\n\x0c\n\x05\x05\0\x02\
    \x02\x01\x12\x03O\x02\t\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03O\x0c\r\ne\
    \n\x04\x05\0\x02\x03\x12\x03S\x02\x0f\x1aX\x20The\x20changed\x20object\
    \x20exists\x20in\x20both\x20service\x20configurations,\x20but\x20its\x20\
